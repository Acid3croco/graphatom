...
-- La tarification est retirée : le rail garde le coût que chaque fournisseur
-- rapporte dans l'usage du run, et rien d'autre. Les deux tables d'estimation
-- partent avec leur service.
DROP TABLE IF EXISTS run_cost;
